...
if len(sys.argv) is not 4:
    print("Correct usage: coolerWordCountTest.py <input text file> <output file> <solution key file>")
    exit()
...
if not os.path.exists("coolerWordCount.py"):
    print ("coolerWordCount.py doesn't exist! Exiting")
    exit()
...
subprocess.call(["python3", "./coolerWordCount.py", textFname, outputFname])

#make sure output file exists
if not os.path.exists(outputFname):
    print ("coolerWordCount output file %s doesn't exist! Exiting" % outputFname)
    exit()
